...
<input type="file"  class="form-control" name="image" id="image"  placeholder="Portada">
</div>
...
<button type="submit" name="accion" <?php echo ($accion!="Seleccionar")?"disabled":""; ?> value="Modificar"  class="btn btn-warning">Editar</button>
